...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IMailboxesApi>();
            ICreateMailboxApiResponse apiResponse = await api.CreateMailboxAsync("todo");
            MailboxViewModel? model = apiResponse.Ok();
        }
...
## Api Information
- appName: DevInbox.ApiService | v1
- appVersion: 1.0.0
